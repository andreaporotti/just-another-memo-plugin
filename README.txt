=== JAMP - Just Another Memo Plugin ===
Contributors: andreaporotti
Tags: memo, note, notes, dashboard
...
This plugin allows you to attach notes to some WordPress elements like posts, pages, dashboard sections and others.
